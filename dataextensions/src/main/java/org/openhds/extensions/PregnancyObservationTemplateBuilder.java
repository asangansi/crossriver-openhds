...
public class PregnancyObservationTemplateBuilder implements ExtensionTemplate  {
	...
	public void buildFieldsAndMethods(JDefinedClass jc) {
		...
		jaHouseDesc.param("description", "House in which this Pregnancy Observation took place.");
		...
		jaHouseholdDesc.param("description", "Household in which this Pregnancy Observation took place.");
