...
INSERT INTO locationhierarchy VALUES ('hierarchy1','TAN','TANZANIA','hierarchyLevelId3','hierarchy_root')
INSERT INTO locationhierarchy VALUES ('hierarchy2','IFA','IFAKARA','hierarchyLevelId2','hierarchy1')
INSERT INTO locationhierarchy VALUES ('hierarchy3','MBI','MBINGU','hierarchyLevelId1','hierarchy2')

INSERT INTO location (uuid,extId,locationName,locationLevel_uuid,locationType,insertDate,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,insertBy_uuid,status,locationHead_uuid) VALUES ('Location1','TANIFAMBI001','Harolds House','hierarchy3','RUR','2012-02-28',NULL,NULL,NULL,false,'FieldWorker1','User 1','A','Indiv 1')
...
INSERT INTO `fieldworker` (uuid, extid, firstname, lastname, deleted) VALUES ('FieldWorker1','FWEK1', 'Editha', 'Kaweza', false);
