...
/**
 * Looks up named queries based on the value of the <code>DynamicFinder</code> annotation. If no value is specified in
 * the finder annotation, it falls back to the same scheme as <code>SimpleNamingStrategy</code>.
 * 
 * @author brent
 * 
 */
