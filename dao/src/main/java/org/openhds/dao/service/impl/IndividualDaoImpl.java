...
/**
 * A specialized class for the Individual entity This was introduced because Individual has to filter out the Unknown
 * Individual whenever it makes a query for searching and/or paging results
 * 
 * @author Dave Roberge
 * 
 */
