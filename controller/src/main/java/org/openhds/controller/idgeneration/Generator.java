...
/**
 * An abstract class that's used as a template for generating id's. The idea is that generators for Location, Visit,
 * Individual, etc will extend this class in order to provide more specific implementations for generating the id.
 * 
...
public abstract class Generator<T> extends LuhnValidator {
    ...
    /**
     * Validate the id length against the idScheme. This should be used especially if the id is being entered manually.
     */
