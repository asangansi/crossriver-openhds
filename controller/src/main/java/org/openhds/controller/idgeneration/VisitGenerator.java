...
/**
 * The Generator for Visit Ids. It examines the siteProperties and based on the template provided, creates the id. Refer
 * to the application-context with the different components involved with the id.
 */
