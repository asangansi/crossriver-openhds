...
public class IndividualServiceImpl implements IndividualService {
    ...
    /**
     * Used to create a custom id based off a counter. The custom id generated will be incremented the number of times
     * of the counter specified. This routine is used to create new individual ids from pregnancy outcome.
     */
    ...
    /**
     * Retrieves all Individual extId's that contain the term provided. Used in performing autocomplete.
     */
    ...
    public VisitableEntity getLatestEvent(Individual individual) {
        ...
        OutMigration om = genericDao.findUniqueByPropertyWithOrder(OutMigration.class, "individual", individual,
                "recordedDate", false);
        InMigration in = genericDao.findUniqueByPropertyWithOrder(InMigration.class, "individual", individual,
                "recordedDate", false);
