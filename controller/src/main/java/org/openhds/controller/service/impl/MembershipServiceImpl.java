...
public class MembershipServiceImpl implements MembershipService {
    ...
    /**
     * Compares the persisted and (soon to be persisted) Membership items. If the persisted item does not have an end
    ...
    /**
     * Compares the persisted and (soon to be persisted) Membership items. If the persisted item and entity item has a
    ...
    /**
     * Helper method for creating a membership. NOTE: This is only being used by the pregnancy outcome web service
     * method
     * 
     * @param startDate
     * @param individual
     ...
     * @return
     */
    public Membership createMembershipForPregnancyOutcome(Calendar startDate, Individual individual, SocialGroup sg,
            FieldWorker fw, String relationToGroupHead) {
